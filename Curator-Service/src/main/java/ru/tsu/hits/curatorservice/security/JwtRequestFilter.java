...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private boolean isExcluded(String path, String method) {
        // If it's a POST request to the specific endpoint, return true (i.e., exclude it from JWT check)
        if (HttpMethod.POST.toString().equals(method) && path.matches("/api/curators/[^/]+")) {
            return true;
        }
